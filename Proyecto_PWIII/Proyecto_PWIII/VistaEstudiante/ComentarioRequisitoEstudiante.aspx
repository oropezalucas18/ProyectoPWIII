...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="server">
    <div class="auto-style5">
        <asp:GridView ID="GridView1" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" runat="server" Width="1753px" CellPadding="4" ForeColor="Black" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="1">
            <Columns>
        ...
        <table width="100%">
            <tr id="ContentPlaceHolder1_CURecursosEstudiante_TRMenu">
                ...
                <td style="width: 70%; height: 100%; vertical-align: top">
                    <fieldset>
                        <asp:Button ID="Button2" runat="server" Text="Comentar" Width="609px" Style="text-align: center" CssClass="auto-style6" />
                    </fieldset>
                </td>
            </tr>
        </table>
        <asp:GridView ID="grvListaComentario" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" runat="server" Width="1748px" CellPadding="4" ForeColor="Black" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="1">
            <Columns>
